    ...
    return (
        <div>
            ...
            <motion.div
                ...
                className="bento-card max-w-2xl mx-auto hover:border-primary/50 transition-all"
            >
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white">Bachelor of Science in Computer Science and Engineering (B.Sc. CSE)</h3>
